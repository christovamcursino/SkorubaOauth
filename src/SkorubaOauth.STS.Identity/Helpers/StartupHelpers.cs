...
using SendGrid;
using SkorubaOauth.STS.Identity.Configuration;
using SkorubaOauth.STS.Identity.Configuration.ApplicationParts;
using SkorubaOauth.STS.Identity.Configuration.Constants;
using SkorubaOauth.STS.Identity.Configuration.Interfaces;
using SkorubaOauth.STS.Identity.Helpers.Localization;
using SkorubaOauth.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using SkorubaOauth.Admin.EntityFramework.MySql.Extensions;
using SkorubaOauth.Admin.EntityFramework.PostgreSQL.Extensions;
using SkorubaOauth.Admin.EntityFramework.Shared.Configuration;
using SkorubaOauth.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace SkorubaOauth.STS.Identity.Helpers
{
