...
using SkorubaOauth.STS.Identity.ViewModels.Account;

namespace SkorubaOauth.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        {
            StaticReturnURL.ReturnURL = returnUrl;
        ...
        {
            if (returnUrl == null)
                returnUrl = StaticReturnURL.ReturnURL;
